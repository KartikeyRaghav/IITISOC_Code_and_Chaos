...
const page = () => {
  ...
  const copyDeploymentId = async () => {
    try {
      await navigator.clipboard.writeText(deployment._id);
      setCopiedId(true);
            ...
            <div className="bg-gradient-to-r from-[#2c2f4a] to-[#1e1f3a] px-8 py-6 border-b border-gray-600/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Build Logs</h3>
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-gray-700/50 hover:bg-gray-700/80 border border-gray-600/30 text-gray-300 hover:text-white transition-all duration-300 text-sm font-medium"
                >
