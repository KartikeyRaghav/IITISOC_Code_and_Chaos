        ...
        <div className="min-h-screen bg-gradient-to-r from-[#004466] via-[#1a365d] to-[#6a00b3] flex items-center justify-center p-4">
            ...
            <div className="relative bg-gradient-to-r from-[#23243a] to-[#1a1b2e] p-8 rounded-3xl shadow-2xl w-full max-w-md border border-purple-500/20 backdrop-blur-sm z-10">
                ...
                <form className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-4 pl-12 rounded-xl bg-[#2c2f4a]/80 text-white border border-gray-600/30 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder-gray-400 backdrop-blur-sm text-center text-lg tracking-widest"
                                disabled 
                            />
                    ...
                    <button
                        type="button"
                        className="w-full py-4 rounded-xl font-bold text-lh shadow-xl bg-gradient-to-r from-[#00aaff] via-[#0099ff] to-[#9a00ff] text-white mt-2 flex items-center justify-center gap-3 opacity-60 cursor-not-allowed"
                        disabled 
                    >
