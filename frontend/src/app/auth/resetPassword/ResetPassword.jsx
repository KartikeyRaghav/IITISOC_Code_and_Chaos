  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#004466] via-[#1a365d] to-[#6a00b3] flex items-center justify-center p-4">
      ...
      {/*header having icon, title*/}
        ...
        <form className="space-y-6" onSubmit={handlePasswordReset}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                type={showPassword ? "text" : "password"} //toggle between psw/text for visibility
              ...
              {/*toggle visibility button on right side*/}
              <button
                type="button"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                type={showConfirmPassword ? "text" : "password"} //toggle visibility for confirm psw
        ...
        {/*display error msg below form if present*/}
        {error && (
