    ...
    <section className="relative w-full min-h-screen flex items-center justify-center px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl flex flex-col items-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 -translate-y-70">
          Welcome to{" "}
          <span className="bg-gradient-to-r from-[#005b83] via-[#0077ab] to-purple-500 bg-clip-text text-transparent">
            IGNITIA
          </span>
        </h1>
        ...
        <button
          className="px-8 py-3 rounded-full font-semibold text-lg shadow-lg bg-gradient-to-r from-custom-blue-300 via-[#00aaff] to-[#9a00ff] text-white transition duration-200 hover:scale-105 hover:shadow-xl hover:from-custom-blue-100 hover:via-[#14b3ff] hover:to-[#8a00e6] focus:outline-none focus:ring-4 focus:ring-[#00aaff]/40 -translate-y-65"
          onClick={() => {
