...
const AppIntro = () => {
    return (
        <section className='w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#003047] to-[#37005c] p-8 shadow-lg h-screen'>
            <img 
                src='/logos/logo_transparent.png'
                alt='Logo'
                className='w-64 h-64 rounded-full shadow-2xl mb-4 border-4 border-white'
            />
            ...
            <p className='text-lg text-purple-100 mb-4 text-center max-w-xl'>From commit to cloud<br/>
