...
export default function ProfileUpload() {
    ...
    const onDrop = useCallback((acceptedFiles) => { //triggered when file id dropped/selected
        ...
        <div className='flex flex-col items-center space-y-4'>
            ...
            >
                ...
                {file ? (
                    ...
                    <p className='text-center'>Drag & drop an image here, or click to select profile picture</p> //if image selected, shows preview, otherwise instructs
                )}
            </div>
